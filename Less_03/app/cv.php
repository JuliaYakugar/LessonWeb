  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <?php foreach($works as $workIndex => $workValue): ?>
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?php echo $workValue['name']; ?> </b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $workValue['date']; ?></h6>
          <p><?php echo $workValue['text']; ?></p>
          <hr>
        </div>
        <?php endforeach; ?>
